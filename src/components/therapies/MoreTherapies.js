...
const elements = [
    {
        ...
        alt: "",
        title: "A.T",
        text: "L'analyse transactionnelle, appelée aussi AT, est une théorie de la personnalité, des rapports sociaux et de la communication . . .",
        path: "/at",
    ...
    },
    {
        ...
        text: "La réflexologie est une méthode qui stimule les processus d’auto-guérison du corps par le biais de pressions exercées sur les zones réflexes situées sur les pieds et les mains . . .",
        path: "/reflexology",
    ...
    },
    {
        ...
        text: "Avec le «  terpnos logos  », la relaxation sophronique , s’adresse au système parasympathique et permet une détente  d’où vont émerger des pensées  et visualisations positives.",
        path: "/sophrology",
